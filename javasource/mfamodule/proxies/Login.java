...
public class Login
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "MFAmodule.Login"));
	}
	...
	protected Login(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject loginMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("MFAmodule.Login", loginMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a MFAmodule.Login");
