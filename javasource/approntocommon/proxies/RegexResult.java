...
public class RegexResult
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "ApprontoCommon.RegexResult"));
	}
	...
	protected RegexResult(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject regexResultMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("ApprontoCommon.RegexResult", regexResultMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a ApprontoCommon.RegexResult");
	...
	{
		return "ApprontoCommon.RegexResult";
	}
