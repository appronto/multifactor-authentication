...
public class Account extends system.proxies.User
{
	...
	/**
	 * @return value of LastLogin2FA
	 */
	public final java.util.Date getLastLogin2FA()
	{
		return getLastLogin2FA(getContext());
	}
	 ...
	 * @return value of LastLogin2FA
	 */
	public final java.util.Date getLastLogin2FA(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.util.Date) getMendixObject().getValue(context, MemberNames.LastLogin2FA.toString());
	}

	/**
	 * Set value of LastLogin2FA
	 * @param lastlogin2fa
	 */
	public final void setLastLogin2FA(java.util.Date lastlogin2fa)
	{
		setLastLogin2FA(getContext(), lastlogin2fa);
	}
	 ...
	 * @param lastlogin2fa
	 */
	public final void setLastLogin2FA(com.mendix.systemwideinterfaces.core.IContext context, java.util.Date lastlogin2fa)
	{
		getMendixObject().setValue(context, MemberNames.LastLogin2FA.toString(), lastlogin2fa);
	}

	/**
	 * @return value of HasMFAenabled
	 */
	public final java.lang.Boolean getHasMFAenabled()
	{
		return getHasMFAenabled(getContext());
	}
	 ...
	 * @return value of HasMFAenabled
	 */
	public final java.lang.Boolean getHasMFAenabled(com.mendix.systemwideinterfaces.core.IContext context)
	{
		return (java.lang.Boolean) getMendixObject().getValue(context, MemberNames.HasMFAenabled.toString());
	}

	/**
	 * Set value of HasMFAenabled
	 * @param hasmfaenabled
	 */
	public final void setHasMFAenabled(java.lang.Boolean hasmfaenabled)
	{
		setHasMFAenabled(getContext(), hasmfaenabled);
	}
